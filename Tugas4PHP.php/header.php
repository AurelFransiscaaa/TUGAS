        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
          ...
          <div class="hidden sm:ml-6 sm:block">
            <div class="flex space-x-4">
              <a href="https://www.instagram.com/aurelfransiscaaa_" target="_blank" class="flex items-center space-x-3 rtl:space-x-reverse">
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white" style="color:white">Aurel Fransisca</span>
              </a>
